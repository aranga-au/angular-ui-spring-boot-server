...
gulp.task('styles', ['clean-styles'], function() {
    ...
    log('source:'+config.less);
    log('dest:'+config.assetTemp);
    return gulp
        .src(config.less)
...
//        .on('error', errorLogger) // more verbose and dupe output. requires emit.
        ...
        .pipe(gulp.dest(config.assetTemp));
});
...
gulp.task('inject-alone',  function() {
    log('Wire up css into the html, after files are ready');
...
gulp.task('optimize', ['inject'], function() {
    ...
    var assets = $.useref.assets({searchPath: './src/main/resources/client/'});
...
gulp.task('build-dep',['build'], function() {
    log("creating atrifact zip");
    return gulp.src(config.build+'*')
           .pipe($.zip('client-artifacts.zip')) 
